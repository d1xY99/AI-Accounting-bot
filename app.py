...
from processor import process_pdf, split_pdf_to_pages, process_fiscal_pdf, KIF_HEADERS, DNEVNI_HEADERS
#
...
_layout = "wide" if st.session_state.page in ("kif", "dnevni") else "centered"
